    ...
    if(empty($name_err) && empty($email_err) && empty($policy_no_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
              ...
              $success = "<script type='text/javascript'> alert('New claim inserted!')";
            } else{
              $unknown_err = "<script type='text/javascript'> alert('Oops there is something wrong with my code. Please call me to rectify!.')";
            }
        }
        ...
        <div class="col-xl-12">
            <div class="card spur-card ">
                <div class="card-header bg-gradient-secondary">
                        <div class="spur-card-title "><h4 class="m-0 font-weight-bold text-info">New Claim</h4></div>
                </div>
                     ...
                     <div class="form-group col-md-6">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-12">
                           <label for="inputAddress2">Describe thr incident</label>
                      <input type="text" name="desc" class="form-control" id="inputAddress2" placeholder="Explain in details how the incident happened and what was stolen" style="length:100px;"><span class="help-block" style="color:red"><i><?php echo $desc_err; ?></i></span>
                        </div>
                            </div>
