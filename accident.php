                 ...
                 <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                     ...
                     <div class="form-row">
                        <div class="form-group col-md-12">
                           <label for="inputAddress2">Describe the Accident.</label>
                      <input type="text" name="desc" class="form-control" id="inputAddress2" placeholder="Explain in details how the accident happened." style="length:100px;"><span class="help-block" style="color:red"><i><?php echo $desc_err; ?></i></span>
                        </div>
                            </div>
